...
public class FluidSphere extends PlacedSphere {
	...
	public FluidSphere(ConfiguredSphere<?> template, float radius, List<ConfiguredSphereDecorator<?, ?>> decorators, List<Pair<EntityType<?>, Integer>> spawns, ChunkRandom random,
	...
	public static class Template extends ConfiguredSphere<Template.Config> {
		...
		@Override
		public FluidSphere generate(ChunkRandom random, DynamicRegistryManager registryManager) {
			...
			return new FluidSphere(this, randomBetween(random, minSize, maxSize), selectDecorators(random), selectSpawns(random), random, fluidBlockState, shellBlock, shellRadius, fillAmount, holeInBottom);
		}
