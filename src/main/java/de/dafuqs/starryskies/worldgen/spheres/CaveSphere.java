...
public class CaveSphere extends PlacedSphere {
	...
	public CaveSphere(ConfiguredSphere<?> template, float radius, List<ConfiguredSphereDecorator<?, ?>> decorators, List<Pair<EntityType<?>, Integer>> spawns, ChunkRandom random,
	...
	public static class Config extends ConfiguredSphere<Config.Config> {
		...
		@Override
		public CaveSphere generate(ChunkRandom random, DynamicRegistryManager registryManager) {
			...
			return new CaveSphere(this, randomBetween(random, minSize, maxSize), selectDecorators(random), selectSpawns(random), random, caveFloorBlock, shellBlock, shellRadius, topBlock, bottomBlock, lootTable);
		}
