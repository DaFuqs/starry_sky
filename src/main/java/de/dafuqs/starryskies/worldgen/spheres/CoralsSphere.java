...
public class CoralsSphere extends PlacedSphere {
	...
	public CoralsSphere(ConfiguredSphere<?> template, float radius, List<ConfiguredSphereDecorator<?, ?>> decorators, List<Pair<EntityType<?>, Integer>> spawns, ChunkRandom random,
	...
	public static class Template extends ConfiguredSphere<Template.Config> {
		...
		@Override
		public CoralsSphere generate(ChunkRandom random, DynamicRegistryManager registryManager) {
			...
			return new CoralsSphere(this, randomBetween(random, minSize, maxSize), selectDecorators(random), selectSpawns(random), random, validShellBlocks, shellRadius, lootTable);
		}
