...
public class DungeonSphere extends PlacedSphere {

	private final EntityType<?> entityType;
	private final BlockStateProvider shellBlock;
	private final float shellRadius;

	public DungeonSphere(ConfiguredSphere<?> template, float radius, List<ConfiguredSphereDecorator<?, ?>> decorators, List<Pair<EntityType<?>, Integer>> spawns, ChunkRandom random,
	...
	public static class Config extends ConfiguredSphere<Config.Config> {
		...
		@Override
		public DungeonSphere generate(ChunkRandom random, DynamicRegistryManager registryManager) {
			int shellRadius = Support.getRandomBetween(random, this.minShellRadius, this.maxShellRadius);
			return new DungeonSphere(this, randomBetween(random, minSize, maxSize), selectDecorators(random), selectSpawns(random), random, entityType, shellBlock, shellRadius);
		}
